...
def add_coordinates( seatmap, cursor ):
  ...
  for hall in halls:
    ...
    for table, t in table_coordinates:
      coordinates = c = Rectangle( t.x1 - x_offset, t.x2 - x_offset, t.y1 - y_offset,
              t.y2 - y_offset, t.x_start - x_offset, t.y_start - y_offset,
...
def table_location(table, tables):
  ...
  return Rectangle( x1, x2, y1, y2, x_start, y_start, width, height, horizontal )
